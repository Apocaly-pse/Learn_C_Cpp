// Persistent stack example of how mmap() naturally creates a software
// abstraction of persistent memory. Author: Terence Kelly
...
int main(int argc, char *argv[]) {
    ...
    p = (pstack_t *)mmap(NULL, file_size, PROT_READ | PROT_WRITE, MAP_SHARED,
                         fd, 0);
    assert(p != MAP_FAILED);
